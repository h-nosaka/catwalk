CREATE TABLE accounts (
	...
	notification_id bigint(20) unsigned NULL COMMENT 'notifications.id',
	role tinyint(3) unsigned NULL COMMENT 'ロール',
	status tinyint(3) unsigned NULL COMMENT 'ステータス',
	flags int(10) unsigned NULL COMMENT 'フラグ',
	freezed_at timestamp NULL COMMENT '削除日',
...
CREATE TABLE account_activates (
	...
	expired_at timestamp NULL COMMENT 'PIN有効期限日時',
	activated_at timestamp NULL COMMENT 'アクティベート日時',
...
CREATE TABLE account_pincodes (
	...
	pincode_id bigint(20) unsigned NOT NULL COMMENT 'pincodes.id',
	expired_at timestamp NULL COMMENT 'PIN有効期限日時',
	deleted_at timestamp NULL COMMENT '使用済み日時',
	created_at timestamp DEFAULT CURRENT_TIMESTAMP NULL COMMENT '作成日',
	updated_at timestamp DEFAULT CURRENT_TIMESTAMP NULL COMMENT '更新日',
	PRIMARY KEY (`id`)
