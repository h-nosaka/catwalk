...
CREATE TABLE pincodes (
	id int4 DEFAULT nextval('pincodes_seq'::regclass) NOT NULL,
...
CREATE TABLE account_activates (
	id int4 DEFAULT nextval('account_activates_seq'::regclass) NOT NULL,
...
CREATE TABLE account_pincodes (
	id int4 DEFAULT nextval('account_pincodes_seq'::regclass) NOT NULL,
	account_id int8 NOT NULL,
	pincode_id int8 NOT NULL,
	expired_at timestamp without time zone,
	deleted_at timestamp without time zone,
